...
yLimit = get(gca,'YLim');
title({'#7: Charge concentrations as a function of \mu'}, ...
    'fontsize', 14, 'fontweight','b')
...
%% 7
%Now let's see what happens if we change the temperature of the system.
%
Tvec=50:40:1000
...
figure(6)
plot(Tvec,mufin,'o-')
title({'#8.1: Chemical potential as a function of temperature'}, ...
    'fontsize', 14, 'fontweight','b')
yLimit = get(gca,'XLim');
...
title({'#8.2: Electron density as a function of T'}, ...
    'fontsize', 14, 'fontweight','b')
